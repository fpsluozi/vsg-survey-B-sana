"""Build the 26 survey pages (13 prompts x base/Gemma4 condition) for the sana model.
...
Images: survey_images/sana_base/<id>.png and survey_images/sana_gemma/<id>.png.
